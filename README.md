...
- [ ] 8. :rainbow: Integrate hierarchical classification and commonsense validation to an existing 3D scene graph algorithm on point cloud datasets for robotic applications.
