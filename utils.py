...
def record_train_results(args, record, rank, epoch, batch_count, lr, lr_db, recall_top3, recall, mean_recall_top3, mean_recall,
    ...
    if args['dataset']['dataset'] == 'vg':
        if args['models']['hierarchical_pred']:
            print('TRAIN, rank %d, epoch %d, batch %d, lr: %.6f, %.6f R@k: %.4f, %.4f, %.4f (%.4f, %.4f, %.4f), mR@k: %.4f, %.4f, %.4f (%.4f, %.4f, %.4f), '
                  'zsR@k: %.4f, %.4f, %.4f (%.4f, %.4f, %.4f), loss: %.4f, %.4f.'
                  % (rank, epoch, batch_count, lr, lr_db, recall_top3[0], recall_top3[1], recall_top3[2], recall[0], recall[1], recall[2],
